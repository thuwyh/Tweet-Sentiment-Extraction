...
# python train_v4.py train test_roberta4 --batch-size 16 --train-file train_roberta2.pkl --fold 0 --bert-path ../../bert_models/roberta_base/ --post #--clean #--weight_decay 0.01 #
# python train_v4.py train test_roberta4 --batch-size 16 --train-file train_roberta2.pkl --fold 1 --bert-path ../../bert_models/roberta_base/ --post #--weight_decay 0.01
# python train_v4.py train test_roberta4 --batch-size 16 --train-file train_roberta2.pkl --fold 2 --bert-path ../../bert_models/roberta_base/ --post #--weight_decay 0.01
# python train_v4.py train test_roberta4 --batch-size 16 --train-file train_roberta2.pkl --fold 3 --bert-path ../../bert_models/roberta_base/ --post #--weight_decay 0.01
# python train_v4.py train test_roberta4 --batch-size 16 --train-file train_roberta2.pkl --fold 4 --bert-path ../../bert_models/roberta_base/ --post #--weight_decay 0.01
