...
# python train_v10.py train v10l --batch-size 16 --fold 0 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
# python train_v10.py train v10l --batch-size 16 --fold 1 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
# python train_v10.py train v10l --batch-size 16 --fold 2 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
# python train_v10.py train v10l --batch-size 16 --fold 3 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
# python train_v10.py train v10l --batch-size 16 --fold 4 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
...
# for i in {0..9}
# do
# python train_v10.py train v10_10 --batch-size 16 --fold $i --bert-path ../../bert_models/roberta_base/ --fgm --post --train-file train_10fold.csv #--smooth #--weight_decay 0.01
# done

# for i in {0..9}
# do
# python train_v10.py validate v10_10 --batch-size 32 --fold $i --bert-path ../../bert_models/roberta_base/ --fgm --post --train-file train_10fold.csv #--smooth #--weight_decay 0.01
# done
# python train_v10.py validate5 v10_10 --batch-size 32 --fold 1 --bert-path ../../bert_models/roberta_base/ --post --train-file train_10fold.csv #--smooth #--weight_decay 0.01
# python train_v10.py predict5 v10_10 --batch-size 32 --fold 0 --bert-path ../../bert_models/roberta_base/ --post --train-file train_10fold.csv #--smooth #--weight_decay 0.01


# for i in {2..9}
# do
# python train_v11.py train v11_10 --batch-size 16 --fold $i --bert-path ../../bert_models/roberta_base/ --fgm --post --train-file train_10fold.csv --offset 7 #--smooth #--weight_decay 0.01
# done
# python train_v11.py validate5 v11_10 --batch-size 32 --fold 1 --bert-path ../../bert_models/roberta_base/ --post --train-file train_10fold.csv --offset 7 #--smooth #--weight_decay 0.01
python train_v11.py predict5 v11_10 --batch-size 32 --fold 0 --bert-path ../../bert_models/roberta_base/ --post --train-file train_10fold.csv --offset 7 #--smooth #--weight_decay 0.01

# for i in {0..9}
# do
# python train_v12.py train v12_10 --batch-size 16 --fold $i --bert-path ../../bert_models/roberta_base/ --fgm --post --train-file train_10fold.csv #--smooth #--weight_decay 0.01
# done
# python train_v12.py validate5 v12_10 --batch-size 32 --fold 1 --bert-path ../../bert_models/roberta_base/ --post --train-file train_10fold.csv #--smooth #--weight_decay 0.01
# python train_v12.py predict5 v12_10 --batch-size 32 --fold 0 --bert-path ../../bert_models/roberta_base/ --post --train-file train_10fold.csv #--smooth #--weight_decay 0.01
