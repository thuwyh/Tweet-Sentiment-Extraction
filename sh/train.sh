...
python train_v10.py train v10 --batch-size 16 --fold 0 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
...
python train_v10.py train v10 --batch-size 16 --fold 1 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
python train_v10.py train v10 --batch-size 16 --fold 2 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
python train_v10.py train v10 --batch-size 16 --fold 3 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #
python train_v10.py train v10 --batch-size 16 --fold 4 --bert-path ../../bert_models/roberta_large/ --n-epochs 3 --fp16 #--limit 3200 #--post #--smooth #--smooth #--clean #--weight_decay 0.01 #

# python train_v10.py train v10 --batch-size 16 --fold 1 --bert-path ../../bert_models/roberta_base/ #--post #--smooth #--weight_decay 0.01
# python train_v10.py train v10 --batch-size 16 --fold 2 --bert-path ../../bert_models/roberta_base/ #--post #--smooth #--weight_decay 0.01
# python train_v10.py train v10 --batch-size 16 --fold 3 --bert-path ../../bert_models/roberta_base/ #--post #--smooth #--weight_decay 0.01
# python train_v10.py train v10 --batch-size 16 --fold 4 --bert-path ../../bert_models/roberta_base/ #--post #--smooth #--weight_decay 0.01
# python train_v10.py train v10 --batch-size 16 --fold 0 --bert-path ../../bert_models/roberta_base/ #--post #--smooth #--weight_decay 0.01
